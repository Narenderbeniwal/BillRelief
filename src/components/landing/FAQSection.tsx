...
export function FAQSection() {
  ...
  return (
    <section id="faq" className="border-t border-gray-200 bg-[#F9FAFB] py-20">
                ...
                return (
                  ...
                  >
                    <button
                      ...
                      className="flex w-full items-center justify-between gap-4 py-5 text-left transition-colors hover:bg-gray-50/80"
                    >
